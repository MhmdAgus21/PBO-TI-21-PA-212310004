	    ...
	    public static void main(String[] args) {
	        ...
	        mainloop: do {
	            try {
	                ...
	                if (value == null) {
	                    int exit = JOptionPane.showConfirmDialog(null, "Apakah Anda ingin keluar?", "Konfirmasi",
	                            JOptionPane.YES_NO_OPTION);
	                    if (exit == 0) {
	                        JOptionPane.showMessageDialog(null, "Terima Kasih!", "Agusse Expedition",
